 ...
 * @author khons
 */
public class data_hasil extends javax.swing.JFrame {

    /**
     * Creates new form data_hasil
     */
    public data_hasil() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Mulai Tanggal", "Sampai Tanggal", "Min Support", "Min Confidence", "Action"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(data_hasil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new data_hasil().setVisible(true);
            }
        });
    }
